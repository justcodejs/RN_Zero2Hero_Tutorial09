# JustCode - React Native Zero to Hero Tutorial 9
Hi! Welcome to JustCode React Native Zero to Hero Tutorial 9 Github page. To run the application in this Github page you need to:
